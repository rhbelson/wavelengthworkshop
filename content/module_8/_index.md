...
*  Run the following command to update system package information and  install necessary prerequisites.
        ...
        libsm6 libxrender1 libfontconfig1 virtualenv libgl1-mesa-glx python3.8-venv python3-pip cmake python3-venv
...
*  Install necessary Python packages.
        ...
        pip install -U pip
        pip3 install flask pillow requests flask-cors opencv-python-headless
